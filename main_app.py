# ==============================================================================
# title              : main_app.py
# description        : This is the flask app for BERT QNA DEMO which receives the request and provide response.
...
# json_json() function is used to convert the input data i.e paragraph and question into the SQUAD like format, then we will be storing this data in a file named input_english.json which is used as prediction file in run_squad command that you will see further in submitted_form() function.
...
def submitted_form():
    ...
    if request.method == 'POST':
        ...
        with open('input_english.json', 'w') as f:
  ...
  --predict_file=input_english.json \
  --init_checkpoint=bert/model/model.ckpt \
  --max_seq_length=184 \
  --doc_stride=40 \
  --max_query_length=40 \
  --do_train=False \
